...
- `components/ui/cypher/button.tsx` - Basic wrapper with pixel borders
- `components/ui/cypher/card.tsx` - Card with outer wrapper
- `components/ui/cypher/dialog.tsx` - Multi-subcomponent wrapper
