...
Keep retro-specific styles in `components/ui/cypher/styles/retro.css`:
...
- `components/ui/cypher/styles/retro.css` - Global retro styles
- `components/ui/cypher/button.tsx` - CSS class usage example
