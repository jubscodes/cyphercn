  ...
  return (
    ...
    >
      ...
      <ChevronDownIcon
        ...
        className="text-foreground pointer-events-none size-4"
      />
    </ComboboxPrimitive.Trigger>
  );
}
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          className={cn(
            ...
            "group/combobox-content relative max-h-96 w-(--anchor-width) max-w-(--available-width) min-w-[calc(var(--anchor-width)+--spacing(7))] origin-(--transform-origin) overflow-hidden shadow-md duration-100 data-[chips=true]:min-w-(--anchor-width)",
...
function ComboboxLabel({
  ...
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn(
        "cyphercn uppercase tracking-wider text-foreground/50 px-2 py-1.5 text-xs pointer-coarse:px-3 pointer-coarse:py-2 pointer-coarse:text-sm",
        className
      )}
      {...props}
    />
...
function ComboboxEmpty({
  ...
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        "cyphercn text-foreground/50 hidden w-full justify-center py-2 text-center text-sm group-data-empty/combobox-content:flex",
        className
      )}
      {...props}
    >
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "rounded-none bg-foreground/10 text-foreground flex h-[calc(--spacing(5.5))] w-fit items-center justify-center gap-1 px-1.5 text-xs font-medium whitespace-nowrap has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0",
        className
      )}
      {...props}
    >
