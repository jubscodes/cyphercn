---
title: Card
description: A terminal-styled card component.
---
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/card"
    command="pnpm dlx shadcn@latest add @cyphercn/card"
  />
</div>

<ComponentPreview title="CypherCN Card" name="card">
