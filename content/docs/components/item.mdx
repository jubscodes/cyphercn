---
title: Item
description: A terminal-styled item component.
---
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/item"
    command="pnpm dlx shadcn@latest add @cyphercn/item"
  />
</div>

<ComponentPreview title="CypherCN Item" name="item">
  <ItemGroup>
