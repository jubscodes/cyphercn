---
title: Table
description: A terminal-styled table component.
---
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/table"
    command="pnpm dlx shadcn@latest add @cyphercn/table"
  />
</div>

<ComponentPreview title="CypherCN Table" name="table">
