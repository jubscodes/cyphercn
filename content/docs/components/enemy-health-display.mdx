...
description: A terminal-styled enemy health display component with health bar, name, and level.
---
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/enemy-health-display"
    command="pnpm dlx shadcn@latest add @cyphercn/enemy-health-display"
  />
</div>

<ComponentPreview title="CypherCN Enemy Health Display" name="enemy-health-display">
