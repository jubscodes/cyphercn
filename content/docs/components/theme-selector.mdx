...
description: A terminal-styled theme selector component with dropdown selection and code copy functionality.
---
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/theme-selector"
    command="pnpm dlx shadcn@latest add @cyphercn/theme-selector"
  />
</div>

<ComponentPreview title="CypherCN Theme Selector" name="theme-selector">
