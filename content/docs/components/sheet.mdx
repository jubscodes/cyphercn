---
title: Sheet
description: A terminal-styled sheet component.
---
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/sheet"
    command="pnpm dlx shadcn@latest add @cyphercn/sheet"
  />
</div>

<ComponentPreview title="CypherCN Sheet" name="sheet">
  <Sheet>
