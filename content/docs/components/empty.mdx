---
title: Empty
description: A terminal-styled empty component.
---
...
import {
  ...
  EmptyMedia,
  EmptyTitle,
} from "@/components/ui/cypher/empty";
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/empty"
    command="pnpm dlx shadcn@latest add @cyphercn/empty"
  />
</div>

<ComponentPreview title="CypherCN Empty" name="empty">
  <Empty>
    <EmptyHeader>
