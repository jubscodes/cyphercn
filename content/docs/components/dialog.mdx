---
title: Dialog
description: A terminal-styled dialog component.
---
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/dialog"
    command="pnpm dlx shadcn@latest add @cyphercn/dialog"
  />
</div>

<ComponentPreview title="CypherCN Dialog" name="dialog">
  <Dialog>
