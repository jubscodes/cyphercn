---
title: Quest Log
description: A terminal-styled mission and task tracking system.
---

import { QuestLog } from "@/components/ui/cypher/blocks/quest-log";
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/quest-log"
    command="pnpm dlx shadcn@latest add @cyphercn/quest-log"
  />
</div>

<ComponentPreview title="CypherCN Quest Log block" name="quest-log">
  <QuestLog
    quests={[
      {
        id: "quest-1",
