---
title: Login Page
description: A terminal-styled two column login page with cover image.
---
...
<div className="flex flex-col md:flex-row items-center justify-end gap-2 mb-2">
  <CopyCommandButton
    copyCommand="pnpm dlx shadcn@latest add @cyphercn/login-page"
    command="pnpm dlx shadcn@latest add @cyphercn/login-page"
  />
</div>
...
```tsx
import LoginPage from "@/components/ui/cypher/blocks/login-page"
```
